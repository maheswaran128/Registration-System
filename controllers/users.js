...
exports.registration=(req,res)=>{
   ...
   /* const name=req.body.name;
    ...
    db.query('select email from users where email=?',
        ...
        if(result.length>0){
            return res.render('registration',{msg:'Email id already taken', 
                msg_type:"error"});
        }
        else if(password!==confirm_password)
        {
            return res.render('registration',{msg:'Password does not match',
                msg_type:"error"
            });
        }
        ...
        db.query("insert into users set?",
            ...
            (error,result)=>{
                if(error){
                    ...
                    console.log(result);
                    return res.render('registration',{msg:'User Registration Success',
                        msg_type:"good"
                    });
                }
            });
